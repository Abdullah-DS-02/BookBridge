        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedBookId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowDurationDays = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BorrowRequests_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfferedBookId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangeRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_AspNetUsers_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Books_OfferedBookId",
                        column: x => x.OfferedBookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Books_RequestedBookId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "BookCount", "Description", "Icon", "Name" },
                values: new object[,]
                {
                    { 1, 0, "Novels, stories, and literary fiction", "bi-book", "Fiction" },
                    { 2, 0, "Biographies, self-help, and real-world stories", "bi-journal-text", "Non-Fiction" },
                    { 3, 0, "Computing, engineering, and sciences", "bi-cpu", "Science & Technology" },
                    { 4, 0, "Finance, marketing, and entrepreneurship", "bi-briefcase", "Business" },
                    { 5, 0, "Textbooks and study materials", "bi-mortarboard", "Academic" },
                    { 6, 0, "Books for kids and young readers", "bi-star", "Children" },
                    { 7, 0, "Historical events and civilizations", "bi-hourglass", "History" },
                    { 8, 0, "Spiritual and philosophical works", "bi-heart", "Religion & Philosophy" },
                    { 9, 0, "Art, architecture, and creative design", "bi-palette", "Arts & Design" },
                    { 10, 0, "Medicine, fitness, and mental health", "bi-heart-pulse", "Health & Wellness" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_OwnerId",
                table: "BorrowRequests",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_OfferedBookId",
                table: "ExchangeRequests",
                column: "OfferedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_RequestedBookId",
                table: "ExchangeRequests",
